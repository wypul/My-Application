...
import com.example.vipul.myapplication.slidelist.Interview_Fragment;
...
public class MainActivity extends Activity {
    ...
    private void updateDisplay(int position) {
        ...
        switch (position) {
            case 0:
                fragment = new Mock_Fragment();
                break;
            case 1:
                fragment = new Quiz_Fragment();
                break;
            case 2:
                fragment = new Predictor_Fragment();
                break;

            case 3:
                fragment = new Interview_Fragment();
                break;
            default:
                break;
        }
